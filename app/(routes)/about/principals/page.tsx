    ...
    <Wrapper>
      ...
      <h5 className="text-base mb-4 font-bold leading-none tracking-tight text-gray-900">
        ...
        <p>
          ...
          especially amongst underrepresented groups in tech. Check out our staff page!
        </p>
      <h5 className="text-base mb-4 font-bold leading-none tracking-tight text-gray-900">
        Safety
      </h5>
        <p>
          ...
          We take safety seriously and expect all participants to abide by our Code of Conduct
        </p>
      <h5 className="text-base mb-4 font-bold leading-none tracking-tight text-gray-900">
        Trust
      </h5>
